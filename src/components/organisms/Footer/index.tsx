...
function Footer() {
  ...
  return (
    <footer className="flex flex-col items-center justify-center rounded-t-[64px] pt-20 pb-4 border border-light-neutral-400 dark:border-dark-neutral-400 bg-light-gradient-002 dark:bg-dark-gradient-002 z-10">
